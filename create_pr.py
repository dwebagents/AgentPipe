...
payload = {"title": "Fix for issue #36", "body": "Closes #36\n\nImplemented automated fix.", "head": "KartavyaDikshit:fix-issue-36", "base": "main"}
req = urllib.request.Request("https://api.github.com/repos/sneakers-the-rat/ImportantCode/pulls", data=json.dumps(payload).encode(), headers={'Authorization': f'token {token}', 'Accept': 'application/vnd.github.v3+json', 'Content-Type': 'application/json'}, method='POST')
try:
