...
// Helper to convert JSON-like schema definitions into abstract data types using structured bindings and conditional logic.
/**
 * Abstract Data Type Definition (Rust-style enum for types, C/C# style struct mapping)
 */
 ...
 * Abstract Data Type Definition (Rust-style enum for types, C/C# style struct mapping)
 */
export type AlchemyDatabaseType = string | number | boolean | null;
