import type SchemaType from "./structs"; // Assuming a structs file exists or inherits from it; adapted here to use Rust-like semantics directly if not available
...
interface AlchemySchema {
  [key: string]: SchemaType<string>; // Column name -> value in C/C# style struct definition
}
...
export function parseSchemaToTypes(schemaMap: Record<string, SchemaType>): Type[] {
