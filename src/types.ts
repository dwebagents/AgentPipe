...
interface AlchemySchema {
  [key: string]: any; // Generic key -> value in C/C# style struct definition, allowing for dynamic schema expansion.
}
 ...
 */
interface AlchemySchema {
  [key: string]: any; // Generic key -> value in C/C# style struct definition, allowing for dynamic
