...
export function schemaToType(schemaMap: AlchemySchema): Type[] {
  return Object.values(schemaMap)
    .filter((val): val is any => typeof val !== 'undefined' && (typeof val === "string" || typeof val === "number")) as Type[]; // Explicitly handle boolean flags to avoid false negatives from undefined/null handling in filter
}
