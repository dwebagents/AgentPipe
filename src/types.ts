...
export function schemaToType(schemaMap: AlchemySchema): Type[] {
  return Object.values(schemaMap)
    .filter((val, idx) => (typeof val === "string" ? true : typeof val !== 'undefined' && typeof val !== 'number')) as any; // Explicitly handle boolean flags to avoid false negatives from undefined/null handling in filter
}
